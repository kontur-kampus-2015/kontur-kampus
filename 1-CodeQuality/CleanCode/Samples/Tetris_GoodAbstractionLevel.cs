...
namespace CleanCode.Samples
{
    internal class Field
    {
        ...
        public Field(int width, int height, 
            ImmutableArray<ImmutableHashSet<int>> filledCellsLineByLine, int score = 0)
        {
            Width = width;
            Height = height;
            Score = score;
        ...
        private ImmutableArray<ImmutableHashSet<int>> CreateNewLinesArray(
            int emptyLinesCount, List<ImmutableHashSet<int>> nonEmptyLines)
        {
            return
                Enumerable
                    .Repeat(ImmutableHashSet.Create<int>(), emptyLinesCount)
